...
func init() {
	...
	groupDescForceOpenaiFast := groupFields[41].Descriptor()
	...
	groupDescFreeOpenaiFast := groupFields[42].Descriptor()
	...
	groupDescMaxReasoningEffortOverLimit := groupFields[50].Descriptor()
