...
const (
	maxFingerprintHeaderValueBytes = 256
...
var defaultFingerprint = Fingerprint{
	...
	StainlessLang:           "js",
	StainlessPackageVersion: claude.SDKPackageVersion,
	StainlessOS:             "Linux",
	StainlessArch:           "arm64",
...
func (s *IdentityService) GetOrCreateFingerprint(ctx context.Context, accountID int64, headers http.Header) (*Fingerprint, error) {
	...
	uaAcceptable := isSafeClaudeFingerprintUserAgent(clientUA)
...
func isSafeClaudeFingerprintUserAgent(ua string) bool {
	return isAcceptableFingerprintUserAgent(ua) && isSafeFingerprintHeaderValue(ua) && claudeCodeUAPattern.MatchString(ua)
}
