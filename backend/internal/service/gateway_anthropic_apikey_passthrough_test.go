...
func TestGatewayService_AnthropicOAuthMimic_PreservesClientSystemAndMessages(t *testing.T) {
	gin.SetMode(gin.TestMode)
...
func TestGatewayService_AnthropicOAuth_IgnoresRetiredSystemPromptSetting(t *testing.T) {
	gin.SetMode(gin.TestMode)
