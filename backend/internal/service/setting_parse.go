...
func (s *SettingService) parseSettings(settings map[string]string) *SystemSettings {
	...
	result := &SystemSettings{
		...
		SiteName:                               s.getStringOrDefault(settings, SettingKeySiteName, "TokenHub"),
	...
	result.AccountSchedulingThresholds = s.defaultAccountSchedulingThresholds()
