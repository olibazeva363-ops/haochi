...
func (m *mockAccountRepoForGemini) ListRateLimitedAccountsForProbe(ctx context.Context, platforms []string, minCooldownRemaining time.Duration, limit int) ([]Account, error) {
	return nil, nil
}
