...
func (s *FailoverState) HandleFailoverError(
	...
	platformRetryAllowed := allowSameAccountRetry(platform, failoverErr.StatusCode)
	sameAccountRetry := platformRetryAllowed && sameAccountRetryAllowed(failoverErr, retryCount, retryLimit)
	...
	// 同账号重试用尽，执行临时封禁
	if platformRetryAllowed && failoverErr.RetryableOnSameAccount {
