export default {
    accounts: {
      ...
      skImport: 'Import SK',
      skImportTitle: 'Import Claude SK',
      skImportHint: 'Paste one or more sk-ant-sid values. The server will convert them and import Anthropic OAuth accounts into the pool.',
      skImportWarning: 'This uses the configured converter cookie. If the server has no SUB2API_CONVERT_COOKIE, paste the converter site cookie below for this import.',
      skImportContent: 'SK values',
      skImportContentPlaceholder: 'sk-ant-sid02-...\nsk-ant-sid02-...',
      skImportContentHint: '{count} SK value(s) detected',
      skImportCookie: 'Converter cookie (optional)',
      skImportCookiePlaceholder: 'auth_token=...; auth_role=user; cf_clearance=...',
      skImportCookieHint: 'Leave empty to use the saved server default cookie (below); otherwise this pasted value is used for this import only.',
      skConvertCookieTitle: 'Server default converter cookie',
      skConvertCookieHint: 'Save the cookie pasted above as the server default. Import / probe / background re-convert all use it. Takes effect immediately, no container restart.',
      skConvertCookieSave: 'Save as default',
      skConvertCookieSaving: 'Saving...',
      skConvertCookieClear: 'Clear',
      skConvertCookieClearing: 'Clearing...',
      skConvertCookieSource: 'Current source',
      skConvertCookieSource_db: 'Saved (database)',
      skConvertCookieSource_env: 'Env SUB2API_CONVERT_COOKIE',
      skConvertCookieSource_none: 'Not configured',
      skConvertURL: 'Converter endpoint',
      skConvertURLNotConfigured: 'SUB2API_CONVERT_URL is not configured. SK values will stay on this server and will not be sent to any third-party converter.',
      skConvertURLConfigured: 'Configured endpoint: {host}',
      skConvertURLLocalTrusted: 'Local/private endpoint',
      skConvertURLRemoteWarning: 'Remote endpoint: verify it is your own trusted converter before importing SK values.',
      skConvertCookieExpiresAt: 'Cookie expires',
      skConvertCookieNone: 'No converter cookie is configured. Save one before importing.',
      skConvertCookieEmpty: 'Paste a cookie above before saving',
      skConvertCookieSaved: 'Default converter cookie saved and now in effect',
      skConvertCookieSaveFailed: 'Failed to save default converter cookie',
      skConvertCookieCleared: 'Default converter cookie cleared',
      skConvertCookieClearFailed: 'Failed to clear default converter cookie',
      skConvertCookieLoadFailed: 'Failed to load default converter cookie status',
      skImportNamePrefix: 'Name prefix',
      skImportConcurrency: 'Concurrency',
      skImportPriority: 'Priority',
      skImportButton: 'Convert and Import',
      skImporting: 'Importing...',
      skImportMissingSK: 'Please paste at least one SK value',
      skImportResult: 'SK Import Result',
      skImportResultSummary: 'Converted {converted}, conversion failed {convert_failed}; accounts created {account_created}, failed {account_failed}',
      skImportSuccess: 'SK import completed: accounts {account_created}',
      skImportCompletedWithErrors: 'SK import completed with errors: converted failed {convert_failed}, account failed {account_failed}',
      skImportFailed: 'SK import failed',
      ...
      oauth: {
        ...
        claudeCredentialsAuth: 'Paste OAuth Credentials',
        claudeCredentialsLabel: 'Claude OAuth JSON',
        claudeCredentialsPlaceholder: 'Paste .claude/.credentials.json or OAuth token JSON',
        claudeCredentialsImport: 'Import OAuth Credentials',
        claudeCredentialsImportFailed: 'Failed to import Claude OAuth credentials',
        claudeCredentialsErrors: {
          invalid_json: 'Credentials must be valid JSON',
          invalid_payload: 'Credentials must be a JSON object',
          access_token_missing: 'Credentials are missing access_token or accessToken',
          expires_at_invalid: 'Credentials contain an invalid expiration time'
        },
        ...
        sessionKeyPlaceholderSingle: 'sk-ant-sid01/02-xxxxx... or sessionKey=...',
        ...
        sessionKeyFormat: 'Accepts a sid01/sid02 value, sessionKey=..., or a full Cookie string containing sessionKey',
        ...
        cookieErrors: {
          ...
          CLAUDE_SESSION_REQUEST_FAILED: 'Could not connect to Claude. Check the account proxy and try again',
          CLAUDE_SESSION_UPSTREAM_ERROR: 'Claude Cookie authorization is temporarily unavailable'
        },
