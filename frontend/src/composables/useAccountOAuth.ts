...
export type AuthInputMethod = 'manual' | 'cookie' | 'claude_credentials' | 'refresh_token' | 'mobile_refresh_token' | 'session_token' | 'access_token' | 'codex_session' | 'agent_identity' | 'codex_pat' | 'sso_cookie'
