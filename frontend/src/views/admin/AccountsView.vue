<template>
  <AppLayout>
              ...
              <div class="relative" ref="accountToolsDropdownRef">
                ...
                >
                  <div class="max-h-[70vh] overflow-y-auto p-2">
                    ...
                    <button class="account-tools-menu-item" @click="openImportSK">
                      <span class="account-tools-menu-icon bg-cyan-50 text-cyan-600 dark:bg-cyan-900/30 dark:text-cyan-300">
                        <Icon name="key" size="sm" />
                      </span>
                      <span class="flex-1 text-left">{{ t('admin.accounts.skImport') }}</span>
                    </button>
    ...
    <ImportSKModal :show="showImportSK" @close="showImportSK = false" @imported="handleSKImported" />
...
import ImportSKModal from '@/components/admin/account/ImportSKModal.vue'
...
const handleSKImported = () => { showImportSK.value = false; reload() }
