...
const retiredClaudeOAuthPromptSettingKeys = new Set<string>([
  "enable_cch_signing",
  "enable_claude_oauth_system_prompt_injection",
  "claude_oauth_system_prompt",
  "claude_oauth_system_prompt_blocks",
...
async function loadSettings() {
  ...
  try {
    ...
    // Ignore retired prompt-rewrite fields still returned by older backends.
    for (const [key, value] of Object.entries(settings)) {
      if (
        !retiredClaudeOAuthPromptSettingKeys.has(key) &&
        value !== null &&
        value !== undefined
      ) {
